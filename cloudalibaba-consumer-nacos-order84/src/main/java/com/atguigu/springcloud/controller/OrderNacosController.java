...
import com.atguigu.springcloud.fegin.PaymentFeginService;
...
//    @SentinelResource(value = "fallback",blockHandler = "handlerFallback") //blockHandler 负责sentinel控制台违规
    ...
    public CommonResult<Payment> paymentSQL(@PathVariable("id") Long id) {
        return paymentFeginService.paymentSQL(id);
    }
